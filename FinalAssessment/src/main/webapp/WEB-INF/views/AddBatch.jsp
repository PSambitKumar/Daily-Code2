...
<body>
	...
	<table align="center">
		<thead>
			<tr>
				<td colspan="2"><center><b>ADD BATCH</b></center></td>
			</tr>
		</thead>
		<tbody>
			<form:form action="Add" method="post" modelAttribute="addstudent">
				<tr>
				...
				<tr>
					<td><center><button type="submit" >Add Batch</button></center></td>
