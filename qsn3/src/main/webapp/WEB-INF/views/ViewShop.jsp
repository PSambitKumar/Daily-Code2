...
<body>
	<h1 align="center">List of Shop</h1>
	<table border = "0" align="center" id="mytable" class="table table-striped table-bordered">
		...
		<c:forEach items="${list}" var="e">
			<tr>
				...
				<td>${e.shopname}</td>
				<td>
					<a href = "${pageContext.request.contextPath}/edit/${e.shopid}">Edit</a>
					|
					<a href = "${pageContext.request.contextPath}/delete/${e.shopid}">Delete</a>
				</td>
