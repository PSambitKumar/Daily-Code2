<%@ page import="java.sql.*" session="true" language="java" contentType="text/html; charset=ISO-8859-1"
...
<title>Edit Product Master</title>
</head>
<body>
	<%
	...
	<div class="login-div">
		<div class="logo"></div>
		<div class="title">Update CSM Product Master</div>
		<div class="fields">
		...
		<div class="submit-button1"><input type="submit" value="Update"></div>
